 ...
 <nav class="navbar navbar-expand-lg navbar-dark fixed-top navbar-shrink" id="mainNav">
            <div class="container-fluid">
                <a class="navbar-brand" href="#page-top"><span class="text-waring">KSA Map Website</span></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="<?php echo $page !='home' ? './':''  ?>#map">Map</a></li>
                        <li class="nav-item"><a class="nav-link" href="./?page=founders">Founders</a></li>
                        ...
                        <?php else: ?>
                          <li class="nav-item"><a class="nav-link" href="javascript:void(0)" id="login_btn"></a></li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
